...
public class MapService
{
    ...
    public MapService(HttpClient httpClient, Utils utils, CurrencyExchangeService currencyExchangeService, ILogger<ErrorMiddleware> logger)
    {
    ...
    TravelPromptContext context)
    {
        ...
        var allocation = _utils.GetBudgetAllocation(place.Category);
